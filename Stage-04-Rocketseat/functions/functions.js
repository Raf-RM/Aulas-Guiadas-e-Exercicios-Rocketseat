...
function Person(name){
  // this sempre vai se referir ao "rafa" la fora e o "rafa" la de fora sempre será referenciado como "this" dentro da função
  this.name = name // cria uma propriedade nova 
  this.walk = function(){ // cria nova funcionalidade
    return this.name + " está andando"
  }
}
const rafa = new Person('Rafael') // essa expressão retorna para a const rafa um objeto (cria um novo objeto) como a função tem um parâmetro name, fornecemos um valor para esse parâmetro "Rafael" que vai ser uma propriedade nova de "rafa".
console.log(rafa)
